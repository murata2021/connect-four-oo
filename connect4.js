...
class Game{
  ...
  //   this.p1.color=player1.value
  //   this.p2.color=player2.value
...
const p1=new Player(1,"orange")
const p2=new Player(2,"#E133FF")
...
formElement.addEventListener("submit",function(event){
  ...
  p1.color=player1.value
  p2.color=player2.value
  console.log(player1.value,player2.value)

})

let a=new Game(p1,p2)
